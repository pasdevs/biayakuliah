...
/**
 * (2) ADAPTER DATA — untuk sambung ke Excel/Sheet.
 *
 * Konsepnya: kamu convert dulu sheet biaya ke JSON (server/build-step), lalu UI ini tinggal consume.
 *
 ...
 *         cicilan1: 7681250,
 *         cicilan2: 6331250,
 *         rincianC1: [{ komponen: "DP", nominal: 937500 }, ...],
 *         rincianC2: [{ komponen: "DP", nominal: 937500 }, ...],
 *       },
 *       ...
 *     ]
 *   }
...
export default function HalamanDetailBiaya() {
  // (1) Tambah Semester 3–8
  // Catatan: contoh data di bawah meniru pola umum (S1 lebih besar karena PKKMB; S2–S4 menengah; S5–S8 lebih ringan).
  // Untuk produksi: ganti dengan data hasil parsing dari sheet final.
  const rawDataContoh = rawDataBiayaProdi;

  // (2) Kalau nanti data sudah dari Excel -> JSON, tinggal ganti rawDataContoh menjadi rawJson dari fetch/api.
