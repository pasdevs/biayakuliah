        ...
        <div className="mx-auto max-w-6xl px-6 py-10">
          ...
          <div className="mt-6 grid grid-cols-1 gap-3 sm:grid-cols-3">
            <div className="rounded-3xl border border-neutral-200 bg-white p-4 shadow-sm">
              ...
              {/* KHUSUS KEDOKTERAN: PILIH GELOMBANG */}
              {isKedokteran && (
                <div className="rounded-3xl border border-neutral-200 bg-white p-4 shadow-sm">
            ...
            {/* TOGGLE RINCIAN → HANYA JIKA BUKAN KEDOKTERAN */}
            {!isKedokteran && (
              <div className="rounded-3xl border border-neutral-200 bg-white p-4 shadow-sm">
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                  <div className="rounded-3xl border border-neutral-200 bg-neutral-50 p-4">
                    <div className="flex items-center justify-between gap-3">
                      <div>
                        <div className="text-xs font-semibold text-neutral-600">{isKedokteran ? "Tahap 1" : "Cicilan 1"}</div>
                  ...
                  <div className="rounded-3xl border border-neutral-200 bg-neutral-50 p-4">
                    <div className="flex items-center justify-between gap-3">
                      <div>
                        <div className="text-xs font-semibold text-neutral-600">{isKedokteran ? "Tahap 2" : "Cicilan 2"}</div>
                        <div className="mt-1 text-base font-extrabold">{isKedokteran ? "" : "Pelunasan Semester"}</div>
                      </div>
